...
<div class="text-center mb-12">
  <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-600 rounded-3xl mb-6 shadow-2xl">
  ...
  <p class="text-xl text-gray-400 max-w-2xl mx-auto">
    Administra y controla todas las órdenes del restaurante en tiempo real
  </p>
</div>
