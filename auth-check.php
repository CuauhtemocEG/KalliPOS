...
function hasPermission($module, $action = 'ver') {
    ...
    $permisos = [
        ...
        'bartender' => [
            ...
            'reportes' => [],
            'cocina' => [],
            'bar' => ['ver', 'editar'], // Solo acceso a bar para preparar bebidas
            'configuracion' => [],
            'usuarios' => []
        ],
        'cajero' => [
            'mesas' => ['ver'],
            'ordenes' => ['ver'], // Solo visualizar órdenes
            'productos' => ['ver', 'crear', 'editar', 'eliminar'], // CRUD completo en productos
            'reportes' => ['ver', 'exportar'], // Solo visualizar reportes y exportar
            'cocina' => ['ver'], // Solo visualizar cocina
            'bar' => ['ver'], // Solo visualizar bar
            'configuracion' => [],
            'usuarios' => []
        ]
    ];
